...
$sql = "SELECT heart_failure, naive_bayes FROM testing";
...
<body>
    <div class="container">
        <div class="card shadow">
			...
			<form method="POST" action="probabilitas.php">
                ...
                <select class="form-select" type="text" id="diabetes" name="diabetes" style="width: 300px; margin-left: 3rem;">
                    <option id="diabetes">0</option>
                    <option id="diabetes">1</option>
                </select>
                ...
                <label class="mb-2 font font-bold" for="heart_failure" style="margin-left: 18rem;">Output You Want</label>
                </div>
                ...
                <select class="form-select" type="text" id="heart_failure" name="heart_failure" style="width: 300px; margin-left: 3rem;">
                    <option>0</option>
                    <option>1</option>
                </select><br>
                </div>
                <div style="display: inline-flex;">
				    <input class="btn submit font" type="submit" value="Submit" style="margin-left: 3rem; margin-top: 1rem;">
				</div>
                <div>
